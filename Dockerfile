...
RUN pacman -Syy --noconfirm fontconfig-infinality-ultimate freetype2-infinality-ultimate cairo-infinality-ultimate ibfonts-meta-base && printf "y\\ny\\n" | pacman -Scc
RUN pacman -S --noconfirm git python-pip texlive-latexextra inkscape gtk2 graphviz mime-types && \
    printf "y\\ny\\n" | pacman -Scc
